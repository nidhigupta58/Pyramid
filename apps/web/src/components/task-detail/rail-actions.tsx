    ...
    <div className="flex items-center justify-end gap-1.5">
      {items.map(({ icon: Icon, label, showCount }, i) => (
        <button
          ...
          type="button"
          aria-label={label}
          className="flex h-[26px] min-w-[26px] items-center justify-center gap-1 rounded-md border border-border-control px-1.5 text-muted-foreground hover:bg-muted"
        >
